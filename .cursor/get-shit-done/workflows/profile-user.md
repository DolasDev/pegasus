...
- @/home/steve/repos/pegasus/.cursor/get-shit-done/references/ui-brand.md (display patterns)
- @/home/steve/repos/pegasus/.cursor/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/steve/repos/pegasus/.cursor/get-shit-done/references/user-profiling.md (profiling reference doc)
  </required_reading>
...
```bash
PROFILE_PATH="/home/steve/repos/pegasus/.cursor/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/home/steve/repos/pegasus/.cursor/get-shit-done/USER-PROFILE.md" "/home/steve/repos/pegasus/.cursor/get-shit-done/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/steve/repos/pegasus/.cursor/get-shit-done/USER-PROFILE.md
...
```bash
SCAN_RESULT=$(node /home/steve/repos/pegasus/.cursor/get-shit-done/bin/gsd-tools.cjs scan-sessions --json 2>/dev/null)
```
...
```bash
SAMPLE_RESULT=$(node /home/steve/repos/pegasus/.cursor/get-shit-done/bin/gsd-tools.cjs profile-sample --json 2>/dev/null)
```
...
- The user-profiling reference doc at `/home/steve/repos/pegasus/.cursor/get-shit-done/references/user-profiling.md`
...
Reference: @/home/steve/repos/pegasus/.cursor/get-shit-done/references/user-profiling.md
...
```bash
QUESTIONS=$(node /home/steve/repos/pegasus/.cursor/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --json 2>/dev/null)
```
...
```bash
ANALYSIS_RESULT=$(node /home/steve/repos/pegasus/.cursor/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --answers "$ANSWERS_PATH" --json 2>/dev/null)
```
...
```bash
node /home/steve/repos/pegasus/.cursor/get-shit-done/bin/gsd-tools.cjs write-profile --input "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Profile written to /home/steve/repos/pegasus/.cursor/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .cursor/rules/" -- "Add profile to /home/steve/repos/pegasus/.cursor/.cursor/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/steve/repos/pegasus/.cursor/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
```bash
node /home/steve/repos/pegasus/.cursor/get-shit-done/bin/gsd-tools.cjs generate-dev-preferences --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Generated /gsd-dev-preferences at /home/steve/repos/pegasus/.cursor/commands/gsd/dev-preferences.md"

**For .cursor/rules/ profile section (if selected):**

```bash
node /home/steve/repos/pegasus/.cursor/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```
...
```bash
node /home/steve/repos/pegasus/.cursor/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --global --json 2>/dev/null
```

Display: "✓ Added profile section to /home/steve/repos/pegasus/.cursor/.cursor/rules/"
...
```bash
BACKUP_PATH="/home/steve/repos/pegasus/.cursor/get-shit-done/USER-PROFILE.backup.md"
```
...
Your profile:    /home/steve/repos/pegasus/.cursor/get-shit-done/USER-PROFILE.md
```
...
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/steve/repos/pegasus/.cursor/commands/gsd/dev-preferences.md
  ✓ .cursor/rules/ section       .cursor/rules/
  ✓ Global .cursor/rules/        /home/steve/repos/pegasus/.cursor/.cursor/rules/
```
