...
// @ts-expect-error Coverage component may not exist yet
...
export function ShipmentDetail({onUpdateShadow, onUpdateNote}: { onUpdateShadow?: () => void; onUpdateNote?: () => void }) {
  ...
  const fields = [
    ...
    {
      accessor: (shipment: any) => (<Link to={`/trip/${shipment.TripMaster_id}`}>
    ...
    {
      accessor: (shipment: any) => `${shipment.shipper_city}, ${shipment.shipper_state}, ${shipment.origin_zip}`,
    ...
    {
      accessor: (shipment: any) => `${shipment.destination_address1}, ${shipment.destination_address2}`,
      label:"",
    },
    {
      accessor: (shipment: any) => `${shipment.consignee_city} ${shipment.consignee_state}, ${shipment.destination_zip}`,
