...
describe('OrderCard', () => {
  it('should display the correct order number', () => {
    const { getByText } = render(<OrderCard order={mockOrder} onPress={() => {}} />)
  ...
  it('should display correct status badge for in_transit order', () => {
    ...
    const { getByText } = render(<OrderCard order={inTransitOrder} onPress={() => {}} />)
  ...
  it('should display correct status badge for delivered order', () => {
    ...
    const { getByText } = render(<OrderCard order={deliveredOrder} onPress={() => {}} />)
  ...
  it('should display item count with plural for multiple items', () => {
    ...
    const { getByText } = render(<OrderCard order={multiItemOrder} onPress={() => {}} />)
  ...
  it('should call onPress when card is pressed', () => {
    ...
    const { getByText } = render(<OrderCard order={mockOrder} onPress={onPressMock} />)
