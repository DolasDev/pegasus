...
import { type TruckingOrder, type OrderStatus } from '../../src/types'
...
export default function OrderDetailScreen() {
  ...
  const handleStatusUpdate = async (newStatus: OrderStatus) => {
    ...
    Alert.alert('Update Status', `Change status to ${statusMap[newStatus]}?`, [
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            ...
            {order.pickup.actualDate && (
              <Text style={styles.actualDate}>Actual: {formatDate(order.pickup.actualDate)}</Text>
            )}
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            ...
            {order.dropoff.actualDate && (
              <Text style={styles.actualDate}>Actual: {formatDate(order.dropoff.actualDate)}</Text>
            )}
          </View>
        </View>

        <View style={styles.section}>
          <Text style={styles.sectionTitle}>INVENTORY ({order.inventory.length} ITEMS)</Text>
          {order.inventory.map((item, _index) => (
