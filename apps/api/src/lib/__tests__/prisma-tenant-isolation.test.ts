...
describe.skipIf(!hasDb)('createTenantDb — cross-tenant isolation (integration)', () => {
  beforeAll(async () => {
    ...
    _dbB = createTenantDb(db, tenantBId) as unknown as PrismaClient
  })
  ...
  describe('CrewMember', () => {
    ...
    it('update via dbA cannot mutate a Tenant B crew member', async () => {
      await dbA.crewMember
        .update({ where: { id: crewBId }, data: { name: 'HACKED' } })
        .catch(() => {})
  ...
  describe('Vehicle', () => {
    ...
    it('update via dbA cannot mutate a Tenant B vehicle', async () => {
      await dbA.vehicle
        .update({ where: { id: vehicleBId }, data: { make: 'HACKED' } })
        .catch(() => {})
  ...
  describe('Move', () => {
    ...
    it('update via dbA cannot mutate a Tenant B move', async () => {
      await dbA.move
        .update({ where: { id: moveBId }, data: { status: 'CANCELLED' } })
        .catch(() => {})
  ...
  describe('LeadSource', () => {
    ...
    it('update via dbA cannot mutate a Tenant B lead source', async () => {
      await dbA.leadSource
        .update({ where: { id: lsBId }, data: { name: 'HACKED' } })
        .catch(() => {})
  ...
  describe('Account', () => {
    ...
    it('update via dbA cannot mutate a Tenant B account', async () => {
      await dbA.account
        .update({ where: { id: accountBId }, data: { name: 'HACKED' } })
        .catch(() => {})
  ...
  describe('Quote', () => {
    ...
    it('update via dbA cannot mutate a Tenant B quote', async () => {
      await dbA.quote
        .update({ where: { id: quoteBId }, data: { status: 'ACCEPTED' } })
        .catch(() => {})
  ...
  describe('Invoice', () => {
    ...
    it('update via dbA cannot mutate a Tenant B invoice', async () => {
      await dbA.invoice
        .update({ where: { id: invoiceBId }, data: { status: 'VOID' } })
        .catch(() => {})
  ...
  describe('InventoryRoom', () => {
    ...
    it('update via dbA cannot mutate a Tenant B inventory room', async () => {
      await dbA.inventoryRoom
        .update({ where: { id: roomBId }, data: { name: 'HACKED' } })
        .catch(() => {})
