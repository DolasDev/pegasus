...
Reference full template: `/home/steve/repos/pegasus/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/steve/repos/pegasus/.claude/get-shit-done/templates/state.md`.
