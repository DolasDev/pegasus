...
```bash
INIT=$(node "/home/steve/repos/pegasus/.codex/get-shit-done/bin/gsd-tools.cjs" init todos)
...
```bash
slug=$(node "/home/steve/repos/pegasus/.codex/get-shit-done/bin/gsd-tools.cjs" generate-slug "$title" --raw)
```
...
```bash
node "/home/steve/repos/pegasus/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: capture todo - [title]" --files .planning/todos/pending/[filename] .planning/STATE.md
```
